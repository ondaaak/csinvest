...
class Item(Base):
    ...
    min_float = Column(Numeric(10, 8), nullable=False, default=0.0)
    max_float = Column(Numeric(10, 8), nullable=False, default=1.0)
    def_index = Column(Integer, nullable=True, index=True)
    paint_index = Column(Integer, nullable=False, default=1)
    rarity_index = Column(Integer, nullable=True)
    paint_seed = Column(Integer, nullable=False, default=1)
